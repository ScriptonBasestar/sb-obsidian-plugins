...
describe('GitService - Startup Pull Methods', () => {
  ...
  describe('isGitRepository', () => {
    ...
    it('should return false when checkIsRepo throws an error', async () => {
      ...
      expect(result).toBe(false);
      expect(consoleSpy).toHaveBeenCalledWith('Failed to check if git repository:', expect.any(Error));
  ...
  describe('hasRemote', () => {
    ...
    it('should return false when getRemotes throws an error', async () => {
      ...
      expect(result).toBe(false);
      expect(consoleSpy).toHaveBeenCalledWith('Failed to check remote configuration:', expect.any(Error));
  ...
  describe('hasUncommittedChanges', () => {
    ...
    it('should return false when getStatus throws an error', async () => {
      ...
      expect(result).toBe(false);
      expect(consoleSpy).toHaveBeenCalledWith('Failed to check uncommitted changes:', expect.any(Error));
