...
var AwesomePlugin = class extends import_obsidian2.Plugin {
  ...
  async insertTemplateWithEngine(editor, template) {
    try {
      ...
      new import_obsidian2.Notice(`Failed to insert template: ${error.message}`);
      const cursor = editor.getCursor();
  ...
  async showVariableInputModal(variableName) {
...
var VariableInputModal = class extends import_obsidian2.Modal {
  constructor(app, variableName, onSubmit) {
    super(app);
    this.inputValue = "";
